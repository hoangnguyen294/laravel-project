						...
						<div id="product-info">
							...
							<div class="row">
								<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
									<img height="350px" width="350px" src="<?= 'data:image;base64,' . $item->prod_img ?>">
								</div>
								<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
									...
									<p>@if($item->prod_status == 1) Còn hàng @else Hết hàng @endif</p>
                                <p class="add-cart text-center"><a href="{{'showcart-'.$item->prod_id}}">Đặt hàng online</a></p>
								</div>
							</div>
						</div>
