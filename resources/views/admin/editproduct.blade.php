							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="<?= 'data:image;base64,' . $product->prod_img ?>">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										<label>Miêu tả</label>
                                        <textarea class="ckeditor" required name="description">{{$product->prod_desciption}}</textarea>
									...
									<div class="form-group" >
                                        ...
                                        <option value="{{$cate->id}}" @if($product->prod_cate == $cate->id) selected @endif>{{$cate->name}}</option>
                                        @endforeach
					                    </select>
									</div>
									<div class="form-group" >
